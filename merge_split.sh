...
cd ../data/seq
split -l 20000 CombinedRuns_denoised_contiged.trim.unique.fasta split_
ls split_* > ../../scripts/split_files.txt
grep ">" BIOCODE2014_MACSE_313.fasta | sed 's/^>//' - > BIOCODE2014_MACSE_313_headers.accnos
